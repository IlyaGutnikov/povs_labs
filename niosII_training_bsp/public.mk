...
JDI_FILE := $(ABS_BSP_ROOT_DIR)/../../../Lab1_POVS.jdi
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x1401078
SOPC_SYSID_FLAG += --sidp=0x1401078
ELF_PATCH_FLAG  += --sidp 0x1401078

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1444122932
SOPC_SYSID_FLAG += --timestamp=1444122932
ELF_PATCH_FLAG  += --timestamp 1444122932
