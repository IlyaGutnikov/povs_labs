...
# Memory: ext_flash_ctl
MEM_0 := ext_flash_ctl
$(MEM_0)_NAME := ext_flash_ctl
...
$(MEM_0)_HIERARCHICAL_PATH := ext_flash_ctl
$(MEM_0)_WIDTH := 8
...
.PHONY: ext_flash_ctl
ext_flash_ctl: check_elf_exists $(HDL_SIM_DIR)/$(MEM_0).dat $(HDL_SIM_DIR)/$(MEM_0).sym $(MEM_0).flash

# Memory: ext_ram_ctl
MEM_1 := ext_ram_ctl
$(MEM_1)_NAME := ext_ram_ctl
...
$(MEM_1)_START := 0x01200000
$(MEM_1)_END := 0x013fffff
$(MEM_1)_SPAN := 0x00200000
$(MEM_1)_HIERARCHICAL_PATH := ext_ram_ctl
$(MEM_1)_WIDTH := 16
...
.PHONY: ext_ram_ctl
ext_ram_ctl: check_elf_exists $(HDL_SIM_DIR)/$(MEM_1).dat $(HDL_SIM_DIR)/$(MEM_1).sym

# Memory: instruction_tcm
MEM_2 := niosII_instruction_tcm
$(MEM_2)_NAME := instruction_tcm
...
$(MEM_2)_END := 0x02003fff
$(MEM_2)_SPAN := 0x00004000
$(MEM_2)_HIERARCHICAL_PATH := instruction_tcm
$(MEM_2)_WIDTH := 32
...
instruction_tcm: check_elf_exists $(MEM_INIT_DIR)/$(MEM_2).hex $(HDL_SIM_DIR)/$(MEM_2).dat $(HDL_SIM_DIR)/$(MEM_2).sym
